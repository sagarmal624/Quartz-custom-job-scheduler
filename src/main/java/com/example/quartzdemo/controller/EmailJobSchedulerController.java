...
public class EmailJobSchedulerController {
    ...
    public ResponseEntity<ScheduleEmailResponse> scheduleEmail(@Valid @RequestBody ScheduleEmailRequest scheduleEmailRequest) {
        try {
            ...
            Trigger trigger = buildJobTrigger(jobDetail, dateTime,scheduleEmailRequest.getCron());
            scheduler.scheduleJob(jobDetail, trigger);

            //scheduler.interrupt(scheduler.getCurrentlyExecutingJobs().get(0).getFireInstanceId());
    ...
    private Trigger buildJobTrigger(JobDetail jobDetail, ZonedDateTime startAt,String cron) {
